...
def load_data(dataset_str):
    ...
    if dataset_str == 'ppi':
        prefix = '/home/mila/r/rebecca.salganik/Projects/LADIES/ppi/ppi' #'./ppi/ppi'
    ...
    for i in range(len(names)):
        with open("/home/mila/r/rebecca.salganik/Projects/LADIES/data/ind.{}.{}".format('cora', names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("/home/mila/r/rebecca.salganik/Projects/LADIES/data/ind.{}.test.index".format('cora'))
